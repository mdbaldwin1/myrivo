-- Single-store cleanup: remove platform-era billing/role tables and fee columns.

drop table if exists public.subscriptions cascade;
drop table if exists public.store_memberships cascade;
drop table if exists public.store_customers cascade;
