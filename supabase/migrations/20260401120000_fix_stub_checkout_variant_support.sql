-- Fix: restore variant-aware logic in stub_checkout_create_paid_order.
-- Migration 20260320230518 regressed the function to use product-level pricing
-- instead of variant-level pricing, causing order items to record the wrong
