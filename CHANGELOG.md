...
### Fixed
- Made refund and dispute digital-access transitions atomic, source-ordered, idempotent, audited, retryable, and reconcilable, with cumulative full-refund revocation and dispute-specific suspension/restoration.
