...
### Fixed
- Made refund and dispute digital-access transitions atomic, deterministically source-ordered, idempotent, audited, retryable, and reconcilable, with one-winner refund execution, durable financial notifications, cumulative full-refund revocation, and dispute-specific suspension/restoration.
