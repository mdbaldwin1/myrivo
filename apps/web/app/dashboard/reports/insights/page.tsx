...
export default async function DashboardReportsInsightsPage() {
  ...
  return (
    <div className="space-y-4">
      <DashboardPageHeader title="Reports · Insights" description="Detailed trends and audit history beyond the Overview snapshot." />
