  ...
  return (
    <StorefrontLoadingShell context={context}>
      <section className={cn("space-y-4", isAiry && "space-y-6")}>
        <div className="h-8 w-40 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_22%,transparent)] motion-reduce:animate-none" />
        <div className="flex items-center justify-between gap-4 border-b border-[color:color-mix(in_srgb,var(--storefront-text)_14%,transparent)] pb-4">
          <div className="space-y-2">
            <div className="h-4 w-28 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
            <div className="h-10 w-48 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_18%,transparent)] motion-reduce:animate-none" />
          </div>
          <div className="hidden gap-3 md:flex">
            {Array.from({ length: 4 }).map((_, index) => (
              <div
                key={`nav-${index}`}
                className="h-4 w-16 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_14%,transparent)] motion-reduce:animate-none"
              />
            ))}
          </div>
        </div>
      ...
      >
        <div className={cn("space-y-4", !isSplitHero && "max-w-3xl text-center")}>
          <div className="h-4 w-24 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_24%,transparent)] motion-reduce:animate-none" />
          <div className="space-y-3">
            ...
            <div className="h-12 w-4/5 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
          </div>
          <div className="space-y-2">
            ...
            <div className="h-4 w-5/6 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_12%,transparent)] motion-reduce:animate-none" />
          </div>
      ...
      <section className={cn("grid", contentGapClass, "md:grid-cols-3")}>
        {Array.from({ length: 3 }).map((_, index) => (
          <div key={`content-${index}`} className={cn("space-y-3 p-5", surfaceClass)}>
            <div className="h-3 w-20 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_22%,transparent)] motion-reduce:animate-none" />
            <div className="space-y-2">
      ...
      <section className="space-y-4">
        <div className="flex items-end justify-between gap-4">
          <div className="space-y-2">
            <div className="h-4 w-24 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_22%,transparent)] motion-reduce:animate-none" />
            <div className="h-8 w-52 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
          </div>
          <div className="hidden h-10 w-40 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-surface)_90%,transparent)] md:block motion-reduce:animate-none" />
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-4">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={`footer-${index}`} className="space-y-3">
              <div className="h-3 w-16 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_20%,transparent)] motion-reduce:animate-none" />
              <div className="space-y-2">
                <div className="h-4 w-24 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_12%,transparent)] motion-reduce:animate-none" />
                <div className="h-4 w-20 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_12%,transparent)] motion-reduce:animate-none" />
