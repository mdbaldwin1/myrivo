    ...
    <StorefrontLoadingShell context={context}>
      <section className="mx-auto max-w-3xl space-y-6">
        <div className="space-y-3 text-center">
          <div className="mx-auto h-4 w-28 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_20%,transparent)] motion-reduce:animate-none" />
          <div className="mx-auto h-10 w-56 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
          <div className="mx-auto h-4 w-2/3 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_10%,transparent)] motion-reduce:animate-none" />
        </div>

        <div className={cn("space-y-5 p-6", surfaceClass)}>
          <div className="space-y-3">
            <div className="h-5 w-40 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
          ...
          <div className="space-y-3 border-t border-[color:color-mix(in_srgb,var(--storefront-text)_12%,transparent)] pt-5">
            ...
            <div className="space-y-2">
              <div className="h-4 w-1/2 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-primary)_18%,transparent)] motion-reduce:animate-none" />
