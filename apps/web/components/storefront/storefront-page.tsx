...
function getPrimaryCtaClass(themeConfig: StorefrontThemeConfig, buttonRadiusClass: string) {
  if (themeConfig.primaryCtaStyle === "accent") {
    return cn("inline-flex h-10 items-center justify-center bg-[var(--storefront-accent)] px-4 text-sm font-medium text-[color:var(--storefront-accent-foreground)] hover:brightness-95", buttonRadiusClass);
  }
  ...
  return cn(
    "inline-flex h-10 items-center justify-center bg-[var(--storefront-primary)] px-4 text-sm font-medium text-[color:var(--storefront-primary-foreground)] hover:brightness-95",
    buttonRadiusClass
  );
}
                          ...
                          <div className="flex flex-col gap-3 pt-1 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            {themeConfig.productCardShowQuickAdd ? (
                              ...
                              <Button
                                ...
                                className={cn("h-9 w-full px-3 bg-[var(--storefront-primary)] text-[color:var(--storefront-primary-foreground)] hover:brightness-95 sm:w-auto", buttonRadiusClass)}
                              >
                                {addToCartLabel}
                              </Button>
                                );
