  ...
  return (
    <StorefrontLoadingShell context={context}>
      <section className="space-y-3">
        ...
        <div className="h-10 w-48 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
            ...
            <div key={`cart-item-${index}`} className={cn("grid gap-4 p-4 sm:grid-cols-[6rem_minmax(0,1fr)]", surfaceClass)}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="h-5 w-20 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_10%,transparent)] motion-reduce:animate-none" />
                </div>
              </div>
            </div>
          ))}
        ...
        <aside className={cn("space-y-4 p-5", surfaceClass)}>
          <div className="h-6 w-32 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_16%,transparent)] motion-reduce:animate-none" />
          <div className="space-y-3">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={`summary-${index}`} className="flex items-center justify-between gap-3">
                ...
                <div className="h-4 w-16 max-w-full animate-pulse bg-[color:color-mix(in_srgb,var(--storefront-text)_10%,transparent)] motion-reduce:animate-none" />
              </div>
            ))}
          </div>
