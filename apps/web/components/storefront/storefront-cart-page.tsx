            ...
            <aside className={cn("space-y-5 p-4 sm:p-5 xl:sticky xl:top-24 xl:h-fit", radiusClass, cardClass, isIntegrated ? "border border-border/60 bg-[color:var(--storefront-surface)] shadow-sm" : "")}>
              ...
              <form id={STOREFRONT_CHECKOUT_FORM_ID} noValidate onSubmit={checkout} className="space-y-2">
                ...
                <div className="relative">
                  <Button type="submit" disabled={pending || cartItems.length === 0} className={cn("h-11 w-full bg-[var(--storefront-accent)] text-[color:var(--storefront-accent-foreground)] hover:brightness-95", buttonRadiusClass)}>
