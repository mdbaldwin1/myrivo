...
export function CookieConsentBanner({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[75] border-t border-border/70 bg-background/95 backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
          <Button type="button" variant="outline" className="min-w-[10rem]" onClick={onOpenPreferences}>
            Customize
          </Button>
          <Button type="button" variant="outline" className="min-w-[10rem]" onClick={onAcceptEssentialOnly}>
            Essential only
          </Button>
          <Button type="button" className="min-w-[10rem]" onClick={onAcceptAll}>
            Accept all
          </Button>
        </div>
      </div>
