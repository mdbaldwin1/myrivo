...
import { Shield, Scale, ScrollText, LayoutDashboard, FileText, ChartNoAxesColumn, Users, DollarSign, Download } from "lucide-react";
...
const links = [
  ...
  { href: "/dashboard/admin/digital-products", label: "Digital Ops", icon: Download },
