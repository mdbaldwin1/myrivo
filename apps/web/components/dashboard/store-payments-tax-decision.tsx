...
export function StorePaymentsTaxDecision({
  ...
  return (
    <SectionCard title="Tax handling decision" description="Choose whether this store will use Stripe Tax or launch under an explicit no-tax seller attestation.">
