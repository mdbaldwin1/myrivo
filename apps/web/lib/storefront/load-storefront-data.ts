...
export async function loadStorefrontData(explicitStoreSlug?: string | null): Promise<StorefrontData | null> {
  ...
  const finalSettings = resolvedSettingsError
    ...
    : {
        ...
        checkout_max_promo_codes: resolvedSettings?.checkout_max_promo_codes ?? 1,
        checkout_notice: resolvedSettings?.checkout_notice ?? null,
        store_alert_enabled: resolvedSettings?.store_alert_enabled ?? false,
        store_alert_title: resolvedSettings?.store_alert_title ?? null,
        store_alert_message: resolvedSettings?.store_alert_message ?? null,
        store_alert_delay_seconds: resolvedSettings?.store_alert_delay_seconds ?? 8,
        store_alert_dismiss_days: resolvedSettings?.store_alert_dismiss_days ?? 7,
